...
insert into template(template_name,template_type,template_content,create_time) values('fig_gearman','fig','{"image":"centos6/gearman:2015-03-13","ports":["4730:4730"],"links":["mysql:mysql_host"],"volumes":["/data/project_name/gearman_code:/data/project_name/gearman_code","/data/project_name/software/gearman-php/php.ini:/etc/php.ini","/data/project_name/software/gearman-php/php.d:/etc/php.d","/data/project_name/software/gearman-php/php-fpm.conf:/etc/php-fpm.conf","/data/project_name/software/gearman-php/php-fpm.d:/etc/php-fpm.d","/data/project_name/log/gearman-php-fpm:/var/log/php-fpm"],"command":""}',datetime());
insert into template(template_name,template_type,template_content,create_time) values('fig_zeromq','fig','{"image":"centos6/zeromq:2015-03-13","ports":[""],"links":["mysql:mysql_host"],"volumes":["/data/project_name/zeromq_code:/data/project_name/zeromq_code","/data/project_name/software/zeromq-php/php.ini:/etc/php.ini","/data/project_name/software/zeromq-php/php.d:/etc/php.d","/data/project_name/software/zeromq-php/php-fpm.conf:/etc/php-fpm.conf","/data/project_name/software/zeromq-php/php-fpm.d:/etc/php-fpm.d","/data/project_name/log/zeromq-php-fpm:/var/log/php-fpm"],"command":""}',datetime());
insert into template(template_name,template_type,template_content,create_time) values('fig_nodejs','fig','{"image":"centos6/nodejs:2015-02-02","ports":["81:80"],"links":["mysql:mysql_host"],"volumes":[""],"command":""}',datetime());